...
import { Divider, List, ListItem, ListItemText } from '@mui/material'; // ✅ correct imports
import fetchModel from '../../lib/fetchModelData.js';
import './userList.css'; // ✅ correct CSS file name
...
class UserList extends React.Component {
  ...
  render() {
    ...
    const activeId = UserList.activeUserId();
